...
class GaussianDiffusion:
    ...
    def update_conditioning_noise(self, pred_noise, t, y_t, x_t, w):
        ...
        """
        return pred_noise - w * _extract_into_tensor(self.sqrt_one_minus_alphas_cumprod, t, y_t.shape) * (y_t - x_t)
    ...
    def p_sample(
        ...
        :param x_start: real original start x
