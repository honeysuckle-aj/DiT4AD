...
class ViT(nn.Module):
    def __init__(self, *, input_size, patch_size, output_size, dim, depth, heads, mlp_dim, pool='cls', channels=3,
    ...
    def forward(self, img):
        x = self.to_patch_embedding(img)  # img 1 9 256 256  输出形状x : 1 196 1024
        b, n, _ = x.shape
